...
## Nickel-Aluminium correlation sensitivity to copper to volatility
library(quantreg)
taus <- seq(.05,.95,.05)	# Roger Koenker UI Bob Hogg and Allen Craig
fit.rq.nickel.aluminium <-  rq(nickel.aluminium ~ copper.vols, tau = taus, data = R.corr.vols)	
fit.lm.nickel.aluminium <- lm(nickel.aluminium ~ copper.vols, data = R.corr.vols)	
plot(summary(fit.rq.nickel.aluminium), parm = "copper.vols", main = "nickel-aluminium correlation sensitivity to copper volatility")
