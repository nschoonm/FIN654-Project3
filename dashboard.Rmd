...
The variance between the value at risk and the expected shortfall is the smallest for copper close to that of aluminium.  Nickel has the greatest value at risk hence a greater expected shortfall.  We can visually see on the nickel graph that the curve is less peaked and therefore has longer tails than both copper and aluminium.  Entering the nickel market is going to be our riskiest investment and therefore require more capital than is required for our existing customers.     
...
[Add data insights. What is the loss limit, VAR, ES, what do they mean?  What about the distribution?] Based on the historical distribution, we are 95% confident that our equally weighted portfolio will not have losses in excess of 194.46.  However, we should reserve 244.99 in the case of an extreme market loss.  It is always wise to look into the extreme tail risk measures, in the case of an extreme event that could affect the market of our commodities.  
